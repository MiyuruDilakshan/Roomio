...
import { Search, UserPlus, ChevronRight, ChevronDown } from 'lucide-react';
          ...
          <div className="des-layout">
            <main className="des-content">
              <div className="flex flex-col h-full">
                {/* Content Area */}
                <div className="flex flex-1 overflow-hidden bg-gray-50 min-w-0">
                {/* Middle Column */}
                <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                  ...
                  {/* Table */}
                  <div className="px-8 pb-8 flex-1 overflow-y-auto min-w-0">
                          ...
                          {filteredClients.map((client, index) => (
                            ...
                            >
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  <div className={`w-10 h-10 ${client.bgColor} rounded-full flex items-center justify-center flex-shrink-0`}>
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors whitespace-nowrap">
                                    View Details
                                  </button>
                                </div>
                              </td>
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm mb-6">
                      ...
                      <div className="p-4">
                        ...
                        <button className="w-full border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 py-2.5 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-colors">
                          Edit Design
                          <ChevronRight size={16} />
                        </button>
                      </div>
